...
HD_PWD='C:/Users/zkran/24h/24h.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log D_Clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source D_Clock.tcl -notrace
